if (oSession.fullUrl.Contains("weather.cma.cn/api/now")) {
            ...
            fso.SaveToFile( "d:\\data\\task\\爬虫\\weather\\weather.cma.cnApiNow\\"+ts+".txt",  2 );
        } 	
if (oSession.fullUrl.Contains("datashareclub.com/area")) {
            var fso;
            var file;
            var now = new Date();
            var month=now.getMonth()+1;
            ...
            fso.Open();
            fso.WriteText("url: " + oSession.fullUrl + " Request body: " + oSession.GetRequestBodyAsString + " Response body: " + oSession.GetResponseBodyAsString());
            fso.SaveToFile( "d:\\data\\task\\爬虫\\weather\\datashareclub.comArea\\"+ts+".txt",  2 );
        } 	
