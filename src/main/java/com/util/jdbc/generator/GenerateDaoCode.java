package com.util.jdbc.generator;


import com.util.jdbc.generator.bean.ClassBean;
import com.util.jdbc.generator.bean.GenerateBean;
import com.util.jdbc.generator.convert.FieldConvert;
import com.util.jdbc.generator.jdbc.TableInfo;
...
public class GenerateDaoCode {
    ...
    public static void pgsqlToBean() {
        String generateFileDir = "D:\\work\\task\\src\\main\\java\\com\\ecommerce\\dao\\generate";
