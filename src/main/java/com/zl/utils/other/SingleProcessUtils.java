...
/**
 * @className: com.craw.nd.util-> SingleProcess
 * @description: windows进程处理
 * @author: zl
 * @createDate: 2023-12-31 16:26
 * @version: 1.0
 * @todo:
 */
public class SingleProcessUtils {
    /**
     * 确保系统中只有一个程序实例
     ...
     * @author Jason
     */
    private static final Logger logger = LoggerFactory.getLogger(SingleProcessUtils.class);
