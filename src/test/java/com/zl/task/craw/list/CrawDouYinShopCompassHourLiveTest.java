...
import com.ecommerce.craw.dy.shop.compass.CrawDouYinShopCompassHourLive;
import com.zl.task.vo.task.taskResource.DefaultTaskResourceCrawTabList;
import com.zl.task.vo.task.taskResource.TaskVO;
import org.junit.Before;
import org.junit.Test;

public class CrawDouYinShopCompassHourLiveTest {
    private CrawDouYinShopCompassHourLive craw;

    @Before
    public void init() throws Exception {
        //测试webdriver；
        craw = new CrawDouYinShopCompassHourLive();
